  ...
  return (
    <div className="flex flex-col space-y-3">
      ...
      <button
        ...
        className="bg-morazul disabled:bg-gray-400 disabled:cursor-default hover:bg-yellow-500 hover:text-black hover:cursor-pointer pt-2 pb-2 pl-5 pr-5 text-white text-xl font-bold rounded-xl w-1/2"
      >
        Pagar
      </button>
